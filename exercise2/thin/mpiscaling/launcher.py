...
if __name__ == "__main__":
  header = f"nodes={NNODES} sockets={PLACES_PER_SOCKET} THIN places={OMP_PLACES} places_per_socket={PLACES_PER_SOCKET} size={SIZE} Imax={IMAX} xL={X_L} yL={Y_L} xR={X_R} yR={Y_R}"
  print("*" * len(header))
  print(header)
  print("*" * len(header))
